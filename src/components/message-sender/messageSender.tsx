...
import StyledMessageSender from "./styles";
import { faPaperPlane } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { getStorage } from "../../utils/localStorageService";
import { getTime12Hours, getTime24hours } from "../../utils/common";
...
export class MessageSender extends React.Component {
  ...
  private handleKeyPress = (e: KeyboardEvent) => {
    ...
    if (getStorage("ctrlEnterSending") !== "On") {
  ...
  private getTime = (): string => {
    return getStorage("clockMode") === "12"
      ? getTime12Hours()
      : getTime24hours();
  };
}
